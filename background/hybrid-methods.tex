...
\textcolor{red}{\textbf{SS:} I would be more careful here: Da et al.
select primitives, not explicit phase variables.}
...
stability. \textcolor{red}{\textbf{SS:} Small correction: ContactNet
is fully connected, and the one-leg setup is experimental.} Omar et
al. \cite{omar_fast_2022} and Villarreal et
...
\textcolor{red}{\textbf{SS:} I would account for Taouil et al.'s
learned evaluator here, since it is close to GaitNet's role.}
