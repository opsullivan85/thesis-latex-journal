...
from high-rate re-decision rather than from an explicit schedule. On
physical hardware, GaitNet (Full) outperforms both the Legged
Perceptive Stack, a leading perceptive NMPC baseline, and ablations
of itself with restricted concurrency (GaitNet-Single,
...
behavior. The hardware results above confirm that the same mechanism
transfers to physical deployment.
