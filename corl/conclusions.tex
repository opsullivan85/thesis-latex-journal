...
widening at the highest difficulties tested. Simulation results and a
swing-schedule analysis from our preliminary framework
\cite{Sullivan2025} first demonstrated this mechanism: the same policy
moves one foot at a time under easy commands and produces overlapping,
non-alternating swings under harder ones, with no change to the
decision rule that produces either behavior. The hardware results
above confirm that the same mechanism transfers to physical
deployment.
