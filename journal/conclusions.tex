...
At deployment, the selected footstep is the exact maximizer
...
difficulties.} Preliminary simulation results from previous work
\cite{Sullivan2025} show the same qualitative mechanism.
