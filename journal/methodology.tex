...
mask. GaitNet scores every valid cell in that mask. It
...
controller stays fixed. Using a frozen learned planner with a
...
\begin{figure*}[t]
  ...
  \caption{System overview. (a)~Deployment: a height scan
...
Learned per-candidate scoring has already made acyclic
...
input. Previous work \cite{Sullivan2025} included a
...
encoder, and trunk. For each sampled candidate,
